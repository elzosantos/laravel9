            ...
            <header class="bg-nav">
                <div class="flex justify-between">
                    <div class="p-1 mx-3 inline-flex items-center">
                        ...
                        <h1 class="text-white p-2">My Car - Sistema de Gestão de Veículos - v1</h1>
                    </div>
                    <div class="p-1 flex flex-row items-center">


                        <img onclick="profileToggle()" class="inline-block h-8 w-8 rounded-full"
                            src="https://avatars.githubusercontent.com/u/6727670?s=40&amp;v=4" alt="">
                        <a href="#" onclick="profileToggle()"
                            class="text-white p-2 no-underline hidden md:block lg:block">Elzo Santos</a>
                            ...
                            <ul class="list-reset">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <button class="no-underline px-4 py-2 block text-black hover:bg-grey-light"
