...
<div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-3/4">
        <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
               id="inline-full-name" name="name" placeholder="Nome:"  type="text" value="{{ $users->name ?? old('name')}}">
    </div>
</div>
<div class="md:flex md:items-center mb-6">
    <div class="md:w-1/4">
    ...
    <div class="md:w-3/4">
        <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
               id="inline-full-name" type="email" name="email" placeholder="E-mail:" value="{{$users->email ?? old('name') }}">
    </div>
</div>
<div class="md:flex md:items-center mb-6">
    <div class="md:w-1/4">
