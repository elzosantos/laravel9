                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                            ...
                            <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                                <div class="px-6 py-2 border-b border-light-grey">
                                    <div class="font-bold text-xl">Top Modelos</div>
                                </div>
                                    ...
                                    <table class="table text-grey-darkest">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>2012</td>
                                                <td>
                                                    <span class="text-red-500"><i class="fas fa-arrow-down"></i>15%</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>2018</td>
                                                <td>
                                                    <span class="text-green-500"><i class="fas fa-arrow-up"></i>32%</span>
                                                </td>
                                            </tr>
                        ...
                        <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2 mt-2">
                            <div class="rounded overflow-hidden shadow bg-white mx-2 w-full pt-2">
                                <div class="px-6 py-2 border-b border-light-grey">
                                    <div class="font-bold text-xl">Top Marcas </div>
                                </div>
                                <div class="">
                                    <div class="w-full">
                        ...
                        <!--Profile Tabs-->
                        <div class="px-6 py-2 border-b border-light-grey">
                            <div class="font-bold text-xl">Top Consultores</div>
                        </div>
                        <div
